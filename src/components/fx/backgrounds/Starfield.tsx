...
const CURSOR_SPEED_BOOST = 6
const CURSOR_BRIGHT_BOOST = 0.6

/**
 * Cursor-reactive starfield — stars twinkle slowly everywhere; stars
 * within CURSOR_RADIUS of the mouse pointer twinkle faster and brighter
 * with a smooth (1 - d/R)² falloff.
 *
 * Lifted from CharClaw-App's `Starfield.tsx`. Lives inside its parent
 * section (absolute positioning) rather than fixed to the viewport.
 */
